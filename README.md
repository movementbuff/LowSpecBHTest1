...
If you prefer to use a different resolution you simply need to open the files in Notepad and Find and Replace all instances of the values "1920" and "810" with whichever resolution values you prefer.
